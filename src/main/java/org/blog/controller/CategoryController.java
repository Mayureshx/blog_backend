...
public class CategoryController {
	...
	public ResponseEntity<Map<String,String>> addCategory(@RequestBody String categoryName)
	{
		try
		{
	...
	public ResponseEntity<Map<String,String>> deteleCategoryById(@PathVariable("categoryId")long categoryId)
	{	
